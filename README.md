...
Este repositório contém o código-fonte de uma API REST de Calculadora desenvolvida em Python utilizando o microframework Flask. O gerenciamento de dependências é feito via pip através do arquivo requirements.txt. Para a conteinerização, atente-se à necessidade de instalar as dependências externas (pip install -r requirements.txt) antes de executar a aplicação. A aplicação expõe a porta 8080.
